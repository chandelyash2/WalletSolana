...
const CommonDrawer: React.FC<CommonDrawerProps> = ({ content, isOpen, closeDrawer }) => {
	...
	return (
		<div
			id="drawer"
			className="absolute top-0 left-1/2 transform -translate-x-1/2 max-h-[600px] h-full  bg-[#232532bf] bg-opacity-50 flex justify-center items-center max-h-[100%] h-full"
		>
